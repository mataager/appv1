(function initFluidBackground() {
  // Wait for the DOM to fully load before injecting the canvas
  ...
  function setupCanvas() {
    // Create a canvas specifically styled to act as a full-page background
    ...
    Object.assign(canvas.style, {
      ...
      pointerEvents: "none", // Lets clicks pass through to your website
      margin: "0",
      padding: "0",
    });

    // Prepend it to the body so it sits behind everything
